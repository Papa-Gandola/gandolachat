...
const s: Record<string, React.CSSProperties> = {
  ...
  tag: { background: "var(--accent)", color: "var(--accent-text)", borderRadius: 12, padding: "2px 8px", fontSize: 12, display: "flex", alignItems: "center", gap: 4 },
  tagX: { cursor: "pointer", fontWeight: 700 },
  btnSm: { background: "var(--accent)", color: "var(--accent-text)", borderRadius: 4, padding: "5px 12px", fontSize: 13, fontWeight: 600 },
  ...
  editNameSave: { background: "var(--accent)", color: "var(--accent-text)", border: "none", borderRadius: 4, padding: "4px 6px", fontSize: 12, cursor: "pointer", flexShrink: 0 },
