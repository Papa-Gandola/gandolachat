...
- **Единый стиль «Б»** (2.3.11, выбор хозяина): (А) кнопки и служебные
  ...
  currentColor, 24×24/1.75; `<Gas>` = фирменный ⛽, везде в UI линейный);
...
2. Покер: шпаргалка комбинаций + шансы банка на мобилку (старый висяк).
3. По желанию: тот же шрифт Twemoji в PWA (web-сборка мобилки) — на
