...
1. **Финал сезона** (ДЕДЛАЙН 30.09!): авто-подиум в последний день месяца,
   карточка 🥇🥈🥉 в чат, рамки gold/silver/bronze (зарезервированы в
   косметике), титул «Чемпион <месяца>», вкладка «Архив сезонов».
2. Пакет «Гандолиум-социалка»: ставки на катки (⛽ за/против, поллер сам
...
3. Опросы в чатах — С ВОЗМОЖНОСТЬЮ вписывать свои варианты (требование
   хозяина); закреплённые сообщения в группах.
4. Релиз мобилки 0.8 (новый APK, versionCode 8): динамик/громкая связь +
   персональная громкость участников (нативный модуль).
5. Адаптивность PWA на широких экранах (два столбца, как договорились).
6. Хвосты звонков: ретраи сигналинга/ICE-restart на мобилке, приём шеринга
